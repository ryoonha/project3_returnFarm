...
const transferNFT = async (req, res) => {
  ...
  //const userPrivateKey = callUserPrivateKey.slice(0, 65);
  ...
  if (ethBalance < 1000000000000000) {
    ...
    try {
      ...
      const callTransferGas = await getGasAmountForTransfer();
      const transferGas = Math.round(callTransferGas * 1.3);
      ...
      web3.eth.accounts
        .signTransaction(rawTransaction721, callUserPrivateKey)
        .then((signedTx) =>
